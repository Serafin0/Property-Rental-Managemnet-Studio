...
namespace WebApplicationFinal.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var appointments = db.Appointments.Include(a => a.PropertyManager).Include(a => a.Status1).Include(a => a.Tenant);
        ...
        public ActionResult Create([Bind(Include = "AppointmentId,TenantId,ManagerId,AppointmentDate,Status")] Appointment appointment)
        {
            ...
            ViewBag.Status = new SelectList(db.Statuses, "StatusId", "StatusName", appointment.Status);
